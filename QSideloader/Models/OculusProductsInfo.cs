...
public static class OculusProductsInfo
{
    ...
    {
        return Products.Find(x => x.ProductName == productName) ?? throw new KeyNotFoundException("Unknown device productName");
    }
...
public class OculusProductProps
{
    ...
    public OculusProductProps(OculusProductType type, string name, string productName, IEnumerable<int> supportedRefreshRates)
    {
        Type = type;
        Name = name;
