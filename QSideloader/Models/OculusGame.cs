...
public class OculusGame
{
    ...
    [JsonProperty("genre_names")] public List<string>? GenreNames { get; set; }
    [JsonProperty("developer_name")] public string? DeveloperName { get; set; }
    [JsonProperty("comfort_rating")] public string? ComfortRating { get; set; }

    [JsonProperty("quality_rating_aggregate")]
    public double QualityRatingAggregate { get; set; }

    [JsonProperty("rating_count")] public int RatingCount { get; set; }
